...
Source8:        zabbix-1.9.10-frontend-ja_jp.po
...
Patch5:         zabbix-1.9.8-itservice_popup_translate.patch
Patch6:         zabbix-1.9.10-powered_by_zabbixjp.patch
...
%defattr(-,root,root,-)
%doc AUTHORS ChangeLog COPYING NEWS README
%doc upgrades/dbpatches database
...
%attr(700,zabbix,zabbix) %{_sbindir}/zabbix_java/bin/zabbix-java-gateway-%{version}.jar
...
- Update to 1.9.10
- Add patch to add link to ZABBIX-JP in header and footer (Patch6)

* Thu Feb 2 2012 Atsushi Tanaka <a.tanaka77@gmail.com> - 1.9.9-0
- Update to 1.9.9
- Update directory hierarchy of sql files for initial databases

* Wed Nov 16 2011 Atsushi Tanaka <a.tanaka77@gmail.com> - 1.9.8-0
- Update to 1.9.8

# NSIS package for ZABBIX 1.4.6 Client for Windows
# (C) 2009 - Kodai Terashima <kodai74@gmail.com>

#          
# Content / Purpose
# -----------------
To build an EXE install package for ZABBIX Agent 1.4.6, using NSIS.
.\img\		: logs and pics
.\Include\	: nsh macros
...
# ---------------------------------------------------------
To install Zabbix agent and sender, just run zabbix_agent-1.4.6-1.JP_installer.exe

To use silent install mode, use :
 zabbix_agent-1.4.6-1.JP_installer.exe [/server=ZabbixServerIPAddress] [/rmtcmd=1] [/S][/D=InstallPath]
...
#Since the the installer 1.4.6.1  
#------------------------------
